...
$$
The fourth effect is the population conditional average treatment effect for each $z \in \{B,C,D,E\}$:
$$
\textrm{pCATE}(z) = N^{-1}\sum_{i = 1}^{N}{\mathbb{E}[Y_{i}(z) - Y_{i}(A) \vert \boldsymbol{\mathbf{X}} = \boldsymbol{\mathbf{x}}_{i}]}.
$$
